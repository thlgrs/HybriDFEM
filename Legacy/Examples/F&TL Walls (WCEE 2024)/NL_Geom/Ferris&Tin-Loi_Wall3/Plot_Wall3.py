...
with open(f'F&TL_Wall3.pkl', 'rb') as file:
    St = pickle.load(file)
...
with h5py.File(file, 'r') as hf:
    ...
    U_final = hf['U_conv'][:, last_conv]

St.U = U_final
St.plot_structure(scale=1, plot_cf=False, plot_forces=False, plot_supp=False, save='Mech3.png')
