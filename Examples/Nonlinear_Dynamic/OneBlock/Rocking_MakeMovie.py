...
for file_name in os.listdir():
    ...
    if file_name.endswith('.h5') and file_name.startswith('_GEN_am=0_'):
...
for i in range(frames_needed): 
    ...
    St.plot_structure(scale=1, plot_cf=False, plot_forces=False, show=False, save=saveto, lims=[[-.5,.5], [-.5, 1.5]])
...
clip.write_videofile('Video_Rocking_HHT.mp4', codec='libx264')