...
class CP_2D: 
    ...
    def __init__(self, x_cp, l_Ax, l_Ay, l_Bx, l_By, angle, h_cp, b, block_A=None, block_B=None, contact=None, surface=None, lin_geom=True):
    ...
    def solve_springs_NL(self):
        ...
        while not loop_conv: 
            ...
            if loop_iters < max_iters: 
                ...
                if np.linalg.norm(self.p_xy_A - self.p_xy_B) < tol: loop_conv = True
                else: loop_iters += 1
